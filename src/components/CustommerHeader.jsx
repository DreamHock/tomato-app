        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="me-4 d-flex">
              <Link to="cart" className="nav-link me-4" href="#" border={1}>
                <span
...
export default CustommerHeader;
